...
**Branch:** `staging` → `main`
**Status:** Phases 1–4 complete; **PR #1 merged — `main` == staging, production live on the merged code (`c06b10c`) via automated deploy, 15/15 prod smoke**. Both envs on one parameterized compose. Remaining: Phase 5 human prep (demo script, attendees, briefing).
